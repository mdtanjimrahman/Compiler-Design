//Write a program that takes user input as a variable declaration syntax (as string) and analyze......
//if the SYNTAX of variable declaration is valid or not
//   Sample:  int number = 0; -> Declaration is Valid.
